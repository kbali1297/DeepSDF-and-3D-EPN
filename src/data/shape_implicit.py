...
class ShapeImplicit(torch.utils.data.Dataset):
    ...
    dataset_path = Path("src/data/sdf_sofas")  # path to sdf data for ShapeNet sofa class - make sure you've downloaded the processed data at appropriate path
    ...
    def __init__(self, num_sample_points, split):
        ...
        self.items = Path(f"src/data/splits/sofas/{split}.txt").read_text().splitlines()  # keep track of shape identifiers based on split
    ...
    def __getitem__(self, index):
        ...
        # : Implement the method get_sdf_samples
